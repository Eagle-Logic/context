...
The repo under analysis: **14 Rust files, 3 Markdown files, 17 modules, 5,083
...
query::tests::a_broken_link_reports_its_own_line_not_its_headings  (src/query.rs:3258-3270  #f94b64f4da35)  → coverage_report
query::tests::coverage_separates_internal_external_and_blind_spots  (src/query.rs:3273-3284  #adf073f295c1)  → coverage_report
query::tests::doctor_names_what_it_could_not_pin  (src/query.rs:2453-2462  #6cd4660b675e)  → coverage_report
query::tests::doctor_recall_excludes_provably_external_calls  (src/query.rs:2428-2440  #6c3b7200040d)  → coverage_report
query::tests::markdown_links_resolve_headings_and_flag_broken  (src/query.rs:3231-3255  #839e24537089)  → coverage_report
    ...
    → mcp::handle_method  [src/mcp.rs:260]
      → mcp::tools_call  [src/mcp.rs:418]
        → mcp::dispatch  [src/mcp.rs:434]
          → query::coverage_report  [src/query.rs:1807]
```
...
## Internal recall — the number to trust
  1093/1135 = 96.3%   of call sites that could be internal, ctx pinned this many.
...
call sites:            5083
  internal edges:      1093   [15 heuristic (~), 0 dispatch fan-out (*)]
  external (provable): 3948   (77.7%)  callee defined nowhere here — std/extern
...
- query::context  (src/query.rs:1321-1587  #086398e3564a)  @ 1363, 1438
