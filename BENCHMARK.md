...
|---|---|---|---|---|---|---|---|
| ripgrep | `new` | 1216 | 35975 | 17594 | 2.0x | 359 | name collision |
| ripgrep | `unwrap` | 1147 | 33526 | 411 | 81.6x | 5 | name collision |
| ripgrep | `arg` | 357 | 9270 | 159 | 58.3x | 2 | **complete** |
| ripgrep | `parse_low_raw` | 565 | 17467 | 108 | 161.7x | 0 | incomplete |
| requests | `get` | 180 | 4812 | 4266 | 1.1x | 89 | name collision |
| requests | `httpbin` | 156 | 4503 | 100 | 45.0x | 0 | incomplete |
| requests | `prepare` | 59 | 1423 | 2008 | 0.7x | 36 | ambiguous |
| requests | `send` | 50 | 1024 | 1206 | 0.8x | 20 | name collision |
| got | `get` | 1308 | 29917 | 285 | 105.0x | 2 | name collision |
| got | `destroy` | 189 | 3430 | 1484 | 2.3x | 33 | incomplete |
| got | `setHeader` | 159 | 4251 | 1544 | 2.8x | 33 | **complete** |
| got | `json` | 141 | 3537 | 996 | 3.6x | 23 | ambiguous |
| cobra | `executeCommand` | 307 | 9084 | 7408 | 1.2x | 193 | **complete** |
| cobra | `Flags` | 205 | 5612 | 3444 | 1.6x | 90 | **complete** |
| cobra | `AddCommand` | 158 | 3174 | 5448 | 0.6x | 135 | **complete** |
| cobra | `Name` | 119 | 3227 | 2365 | 1.4x | 65 | **complete** |
| chi | `Get` | 260 | 6994 | 3382 | 2.1x | 92 | incomplete |
| chi | `Write` | 222 | 4406 | 385 | 11.4x | 4 | incomplete |
| chi | `HandlerFunc` | 169 | 5402 | 153 | 35.3x | 2 | name collision |
| chi | `testRequest` | 154 | 5177 | 1468 | 3.5x | 40 | ambiguous |
| preact | `render` | 58 | 1034 | 272 | 3.8x | 2 | incomplete |
| preact | `createElement` | 21 | 526 | 142 | 3.7x | 0 | incomplete |
| preact | `createSignal` | 11 | 315 | 252 | 1.2x | 3 | ambiguous |
| preact | `unstable_runWithPriority` | 7 | 197 | 223 | 0.9x | 1 | incomplete |
...
Over the 6 `complete` answers above, the median is **1.5x** fewer tokens than the fair grep.
