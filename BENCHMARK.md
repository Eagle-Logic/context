...
|---|---|---|---|---|---|---|
| ripgrep | rust | `3fce3b5` | 110 | **4601/7105 = 64.8%** | 2504 | `parse_low_raw` ×560, `path` ×371, `build` ×221 |
| requests | python | `611c616` | 37 | **976/1171 = 83.3%** | 195 | `httpbin` ×155, `should_strip_auth` ×9, `httpbin_secure` ×8 |
| got | ts | `e1d87d2` | 82 | **1701/2242 = 75.9%** | 541 | `request` ×93, `delay` ×79, `now` ×70 |
...
| got | `destroy` | 189 | 10171 | 1318 | 7.7x | 30 | incomplete |
| got | `setHeader` | 159 | 9922 | 1475 | 6.7x | 32 | **complete** |
| got | `json` | 141 | 8566 | 800 | 10.7x | 19 | ambiguous |
...
Generated by `./bench/run.sh` from `bench/repos.tsv` (5 repositories).
